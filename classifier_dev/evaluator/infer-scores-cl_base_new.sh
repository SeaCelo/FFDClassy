...
./mallet-2.0.8/bin/mallet import-dir --input /Users/mlafleur/Projects/SDGclassy_dev/classifier_dev/sources/cl_base_new  --output ./classifier/inferring-temp.mallet --keep-sequence --remove-stopwords --extra-stopwords ./classifier/extra-exclude-words.txt --keep-sequence-bigrams --gram-sizes 1,2  --use-pipe-from ./classifier/sdg.mallet   
